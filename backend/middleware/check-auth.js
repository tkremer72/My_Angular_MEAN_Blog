...
module.exports = (req, res, next) => {
  ...
  that is accompausernying the token inside of the header at the white space and then we
 ...
 try {
  ...
  const decodedToken = jwt.verify(
    ...
    req.userData = { user_email: decodedToken.user_email, userId: decodedToken.userId }
    next();
 }  catch(error) {
